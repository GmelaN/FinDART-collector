...
class FakeNim:
    def create_daily_briefing(self, articles, policy_briefings=None, market_indicators=None):
        if not hasattr(self, "requests"):
            self.requests = []
        self.requests.append({"articles": articles, "policy_briefings": policy_briefings, "market_indicators": market_indicators})
        return {
            "title": "오늘의 시장 브리핑",
